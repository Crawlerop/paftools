...
if __name__ == "__main__":
    ...
    assert bpp in [8,16,18,24,32], f"{bpp}-bit PAF images is not supported."
    #if bpp in [18] and not RAW: raise Exception("Image output for this type is not currently supported.")
